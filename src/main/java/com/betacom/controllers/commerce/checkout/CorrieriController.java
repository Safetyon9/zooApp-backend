...
@RestController
@RequestMapping("/rest/corrieri")
public class CorrieriController {

    private final ICorrieriServices corS;
    private final IMessaggiServices msgS;

    @PostMapping("/create")
    public ResponseEntity<Resp> create(@RequestBody(required = true) CorrieriReq req) {
        Resp r = new Resp();
    ...
    @PutMapping("/update")
    public ResponseEntity<Resp> update(@RequestBody(required = true) CorrieriReq req) {
        Resp r = new Resp();
        HttpStatus status = HttpStatus.OK;
        try {
            corS.update(req);

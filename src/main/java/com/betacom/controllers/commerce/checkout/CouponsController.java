...
public class CouponsController {
	...
	private final ICouponsServices couponsS;
	private final IMessaggiServices msgS;
	
	@PostMapping("/create")
	public ResponseEntity<Resp> create(@RequestBody(required = true) CouponsReq req) {
		Resp r = new Resp();
	...
	@PutMapping("/update")
	public ResponseEntity<Resp> update(@RequestBody(required = true) CouponsReq req){
		Resp r = new Resp();
		HttpStatus status = HttpStatus.OK;

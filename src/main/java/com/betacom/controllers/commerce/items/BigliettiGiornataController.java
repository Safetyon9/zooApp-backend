...
public class BigliettiGiornataController {
    ...
    private final IBigliettiGiornataServices bigS;
    ...
    @PostMapping("/create")
    public ResponseEntity<Resp> create(@RequestBody(required = true) BigliettiGiornateReq req) {
        Resp r = new Resp();
        HttpStatus status = HttpStatus.OK;
        try {
            bigS.create(req);
    ...
    @PutMapping("/update")
    public ResponseEntity<Resp> update(@RequestBody(required = true) BigliettiGiornateReq req) {
        Resp r = new Resp();
        HttpStatus status = HttpStatus.OK;
        try {
            bigS.update(req);

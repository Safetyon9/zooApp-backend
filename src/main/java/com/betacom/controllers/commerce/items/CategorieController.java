...
public class CategorieController {
    ...
    @PostMapping("/create")
    public ResponseEntity<Resp> create(@RequestBody(required = true) CategorieReq req) {
        Resp r = new Resp();
    ...
    @PutMapping("/update")
    public ResponseEntity<Resp> update(@RequestBody(required = true) CategorieReq req) {
        Resp r = new Resp();
        HttpStatus status = HttpStatus.OK;
        try {
            catS.update(req);
